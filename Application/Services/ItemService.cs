...
namespace bootcamp_store_backend.Application.Services
{
    ...
    {
        private readonly IItemReposity _itemRepository;
        private readonly IImageVerifier _imageVerifier;

        public ItemService(IItemReposity repository, IMapper mapper, IImageVerifier imageVerifier) : base(repository, mapper)
        {
