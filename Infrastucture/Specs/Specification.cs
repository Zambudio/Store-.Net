    ...
    public class Specification<T>
    {
        ...
        { 
            ...
            foreach (var criterion in _criteria) 
            {
                ...
                {
                    case "EQUAL":
                        predicate = Expression.Equal(property, constant); break;
                    case "GREATER_THAN":
                        predicate = Expression.GreaterThan(property, constant); break;
                    case "LESS_THAN":
                        predicate = Expression.LessThan(property, constant); break;
                    case "GREATER_THAN_EQUAL":
                        predicate = Expression.GreaterThanOrEqual(property, constant); break;
                    case "LESS_THAN_EQUAL":
                        predicate = Expression.LessThanOrEqual(property, constant); break;
                    case "NOT_EQUAL":
                        predicate = Expression.NotEqual(property, constant); break;
                    case "MATCH":
                        predicate = Expression.Call(ToCaseInsensitiveStringExpression(property), "Contains", null, ToCaseInsensitiveStringExpression(constant)); break;
                    case "MATCH_START":
                        predicate = Expression.Call(ToCaseInsensitiveStringExpression(property), "StartsWith", null, ToCaseInsensitiveStringExpression(constant)); break;
                    case "MATCH_END":
                        predicate = Expression.Call(ToCaseInsensitiveStringExpression(property), "EndsWith", null, ToCaseInsensitiveStringExpression(constant)); break;
                    default:
